...
public class SingleLinkedList<T> extends SingleLinkedListAbstract<T> implements SingleLinkedListInterface<T>, Iterable<T>{
    ...
    public boolean contains(T o) {
        ...
        for (int i = 0; i < size; ++i) {
            // -- must wrap the object o in an LLNode to make sure the .equals works
            // properly
    ...
    // -- returns reference to the first occurrence of the object if it is in the
    // list
    ...
    // -- returns the index of the first occurrence of the object if it is in the
    // list
    ...
    // -- returns the index of the last occurrence of the object if it is in the
    // list
