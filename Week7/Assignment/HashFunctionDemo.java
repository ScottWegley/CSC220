...
public class HashFunctionDemo {
    ...
    // -- note that long strings will cause hash and hashalt to produce different
    // results
    ...
    public static int hash5(String key) {
        ...
        int a[] = { rn.nextInt() % HASHRANGE, rn.nextInt() % HASHRANGE, rn.nextInt() % HASHRANGE,
                rn.nextInt() % HASHRANGE };
